clear all
set more off
use "/Users/floydluo/Desktop/Covid19-Vaccination-Race-Disparity/StataCode/subsample_analysis_6_and_10_states/10StateAllWhite/DataNorm.dta"
...
reg CvdVax_DisparityY MedianInc_WholeAvg MedianInc_Disparity HighSchool_WholeRate HighSchool_Disparity FacNumRate CaseRate IT_WholeRate IT_Disparity urban vehicle republican_rate Segregation racial_weighted_bias Black_Prop state_dummy1-state_dummy10  [pweight=org_WholeNum] , r cluster(State)

outreg2 using StataCode/subsample_analysis_6_and_10_states/10StateAllWhite/RegResult.doc, replace ctitle(CvdVax_D) addtext(SD, True, R, True, C, True, W, True)  keep (MedianInc_WholeAvg MedianInc_Disparity HighSchool_WholeRate HighSchool_Disparity FacNumRate CaseRate IT_WholeRate IT_Disparity urban vehicle republican_rate Segregation racial_weighted_bias Black_Prop) excel alpha(0.001, 0.01, 0.05, 0.10) symbol(***, **, *, +)


reg CvdVax_DisparityY MedianInc_WholeAvg MedianInc_Disparity HighSchool_WholeRate HighSchool_Disparity FacNumRate CaseRate IT_WholeRate IT_Disparity urban vehicle republican_rate Segregation racial_weighted_bias Black_Prop FluVax_WholeRate FluVax_Disparity state_dummy1-state_dummy10  [pweight=org_WholeNum] , r cluster(State)

outreg2 using StataCode/subsample_analysis_6_and_10_states/10StateAllWhite/RegResult.doc, append ctitle(CvdVax_D) addtext(SD, True, R, True, C, True, W, True)  keep (MedianInc_WholeAvg MedianInc_Disparity HighSchool_WholeRate HighSchool_Disparity FacNumRate CaseRate IT_WholeRate IT_Disparity urban vehicle republican_rate Segregation racial_weighted_bias Black_Prop FluVax_WholeRate FluVax_Disparity) excel alpha(0.001, 0.01, 0.05, 0.10) symbol(***, **, *, +)


reg CvdVax_DisparityY MedianInc_WholeAvg MedianInc_Disparity HighSchool_WholeRate HighSchool_Disparity FacNumRate CaseRate IT_WholeRate IT_Disparity urban vehicle republican_rate Segregation racial_weighted_bias Black_Prop FluVax_WholeRate FluVax_Disparity Above75_WholeRate Above75_Disparity state_dummy1-state_dummy10  [pweight=org_WholeNum] , r cluster(State)
...
reg CvdVax_DisparityY MedianInc_WholeAvg MedianInc_Disparity HighSchool_WholeRate HighSchool_Disparity FacNumRate CaseRate IT_WholeRate IT_Disparity urban vehicle republican_rate Segregation racial_weighted_bias Black_Prop FluVax_WholeRate FluVax_Disparity Above75_WholeRate Above75_Disparity A15T74_WholeRate A15T74_Disparity state_dummy1-state_dummy10  [pweight=org_WholeNum] , r cluster(State)
